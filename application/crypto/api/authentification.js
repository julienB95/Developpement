...
async function utilisateurDepuisJeton(jeton) {
    ...
    const { rows } = await db.requete(
        `SELECT u.id, u.courriel, u.nom, u.prenom, u.est_actif, u.est_admin, u.devise, u.autorise_google, u.est_bloque, u.plateforme_defaut, u.staking_acquisition, u.cree_le, s.expire_le
         FROM session s
